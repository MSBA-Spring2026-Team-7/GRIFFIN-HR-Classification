...
PROJECT_ROOT = os.path.join(SCRIPT_DIR, "..")  # app/ is one level below project root
DATA_DIR = os.path.join(PROJECT_ROOT, "data", "reference")
TRAINING_DATA_PATH = os.path.join(PROJECT_ROOT, "data", "training", "workday_training.csv")
